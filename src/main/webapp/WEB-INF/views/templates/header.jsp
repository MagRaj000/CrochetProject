...
<head>
    ...
    <link href="${pageContext.request.contextPath}/theme/vendor/fontawesome-free/css/all.min.css" rel="stylesheet"
          type="text/css">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <c:if test="${isLoggedIn}">
                        <span class="mr-2 d-none d-lg-inline text-gray-600">Welcome, ${username}!</span>
                    </c:if>
                    <c:choose>
                        ...
                        <c:otherwise>
                            ...
                            <a href="${pageContext.request.contextPath}/login"
                               class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                <i class="fas fa-sign-in-alt fa-sm text-white-50"></i> Log in
                            </a>
                        </c:otherwise>
                    </c:choose>
                </div>